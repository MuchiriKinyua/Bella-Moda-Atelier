...
--
-- Host: localhost
-- Generation Time: Jan 13, 2025 at 09:42 AM
...
(1, 'Muchiri Kinyua', 'muchiri.kinyua@gmail.com', NULL, '$2y$12$6WfxU01lrgDgSKNxN/dwgeZcPyrYPvRp/x21/C0L9Nvj6p1Q7epA2', NULL, '2025-01-08 06:56:10', '2025-01-08 06:56:10');
...
--
-- Indexes for table `lingeries`
--
ALTER TABLE `lingeries`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `lingeries`
--
ALTER TABLE `lingeries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
